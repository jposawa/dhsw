...
export const STORAGE_VERSIONS = {
  /** v2: `Character.partyId`. v3: `Character.tokens`. v4: `Character.houseRules`. v5: ascendência mista. v6: `Character.heritage`, com código, nome e a espécie de cada feature. v7: uma forma só de ascendência — nome, duas fontes e `isMixed`, sem código sentinela. */
  roster: 7,
