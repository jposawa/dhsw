...
export const SKILLS: readonly Skill[] = [
  ...
  },
  {
    ...
    "recallCost": 2,
    "category": "Ability",
    "text": "A number of times equal half your **Proficiency** (Rounded up) per Rest, when an enemy in *Melee* Range would deal damage to you, you can avoid the damage entirely and safely move out of *Melee* range of the enemy."
  },
  {
    "name": "Provoke",
    "domain": "Aegis",
  ...
  },
  {
    ...
    "recallCost": 1,
    "category": "Ability",
    "text": "While you are wearing an Armor and this card is in your Loadout, increase your Armor Score by **+1** plus your **Knowledge score**.\nDuring a *Rest*, if you choose to take the **Repair** Armor downtime action, everybody in your party also clears one additional Armor Slot."
  },
  {
    "name": "Conviction",
    "domain": "Aegis",
  ...
  },
  {
    ...
    "recallCost": 0,
    "category": "Ability",
    "text": "Make a **Presence** roll against a target within *Close* range. ON a success, you can temporarily keep their attention on you. Once per *Rest*, you may also mark a **Stress** on a success to deal a **Stress** to the target."
  },
  {
  ...
  },
  {
    ...
    "recallCost": 1,
    "category": "Ability",
    "text": "During a *Rest*, when you use the **Tend to Wounds** downtime move on another character, ou may speak supportive words to heal an extra Hit Point on them. When you do, also heal two of your own."
  },
  {
    "name": "Body Reader",
    "domain": "Allure",
  ...
  },
  {
    ...
    "recallCost": 1,
    "category": "Ability",
    "text": "During a *Rest* you can always choose to do one of the *Long Rest* options instead. You may spend a **Hope** to let one additional party member do the same."
  },
  {
    "name": "Art Mastering",
    "domain": "Allure",
  ...
  },
  {
    ...
    "recallCost": 1,
    "category": "Ability",
    "text": "Spend a **Hope** to deploy a small droid. It stays until your next *Rest*, until it takes damage, or until you deactivate it with a Reaction. Spend an extra **Hope** to make it a floating droid.\nYou can talk to it, or through it to others. Make a **Finesse** or **Knowledge** roll to command simple tasks, or mark a **Stress** to see through its eyes.\n### Shield\nWhile *Very Close* to you, it reduces an incoming Damage by your Armor Score plus your Proficiency. It then deactivates unless you spend a **Hope**.\n### Drone Attack\nSpend an Action to send it against a target within *Close* of it. Make a **Finesse** or **Knowledge** attack roll. On a success, deal **2D8** energy damage."
  },
  {
  ...
  },
  {
    ...
    "recallCost": 2,
    "category": "Ability",
    "text": "Once per *Rest*, you can use an Action to trigger a field of tiny healing robots around you. Everywhere within *Close Range* of you is covered by this small cloud of tiny floating drones, causing you and your allies in the area to immediately heal one Hit Point.\nYou can spend a **Hope** to increase the healing power by an additional Hit Point."
  },
  {
    "name": "Signature Move",
    "domain": "Edge",
    ...
    "recallCost": 1,
    "category": "Ability",
    "text": "When you take this card, you take on a signature move in battle that you can perform once per *Rest*. Name it and describe it. When you include its description in an action you’re taking, use a **D20** instead of a **D12** as your **Hope** die. If the attack succeeds, you may clear a **Stress**."
  },
  {
  ...
  },
  {
    ...
    "recallCost": 2,
    "category": "Ability",
    "text": "When a majority of the domain cards in your Loadout are from Edge domain:\n- Increase your **Agility** by 1.\n- Once per *Rest*, you can do a **Finesse** or **Agility** roll using the double of the trait score."
  },
  {
  ...
  },
  {
    ...
    "recallCost": 3,
    "category": "Holocron",
    "text": "### Shared Feature\nOnce per Rest, you can spend a **Serenity**, or mark a **Strife**, to choose a **Trait** or **Experience** from an ally.\nThe Trait score can’t be higher than your Forcewield trait score, and the Experience level must be bellow your highesr Experience.\nMark a number of **Stress** equal half of the chosen **Feature** (Rounded up) and you can use it as if you had it until your next Downtime period, or you get unconscious.\n### Bonded Skill\nOnce per *Rest*, you can choose a level **8 or lower** card from another player’s Loadout. Spend a number of **Hope** equal to half chosen card’s level (Rounded up), and this skill can mimic the features of chosen card."
  },
  {
    "name": "Shatterpoint",
    "domain": "Essence",
  ...
  },
  {
    ...
    "recallCost": 2,
    "category": "Ability",
    "text": "Once per *Rest*, you can make a **Finesse Roll (15)**. On a sucess, spend a **Hope** to place a Ray shield wall from one point within *Close* range of you, to another. The wall can be as high as **30ft (9m)**. Any creature or objects in its path are shunted to one side.\nIt will dissipate at the end of your next *Rest*, when you use this ability again, or when GM spend **2 Fear** to end it."
  },
  {
...
export const SKILL_SEARCH_INDEX: Readonly<Record<string, string>> =
  ...
  "Feet Play": "feet play aegis a number of times equal half your proficiency rounded up per rest when an enemy in melee range would deal damage to you you can avoid the damage entirely and safely move out of melee range of the enemy",
  ...
  "Refreshing Wind": "refreshing wind aegis after you finish a rest place tokens on this card until their numbers are equal your proficiency when you successfully strike an enemy you may spend a token to clear 3 stress or 1 hit point on a success with hope you may also clear 3 stress or 1 hope of an ally within close range",
  "Armorer": "armorer aegis while you are wearing an armor and this card is in your loadout increase your armor score by 1 plus your knowledge score during a rest if you choose to take the repair armor downtime action everybody in your party also clears one additional armor slot",
  ...
  "Aegis Focus": "aegis focus aegis when a majority of the domain cards in your loadout are from aegis domain your armor score increases by 2 while this ability is in your loadout your maximum stress is increased by 1",
  ...
  "Elate": "elate allure make a presence roll against a target within close range on a success you can temporarily keep their attention on you once per rest you may also mark a stress on a success to deal a stress to the target",
  ...
  "Warm Words": "warm words allure during a rest when you use the tend to wounds downtime move on another character ou may speak supportive words to heal an extra hit point on them when you do also heal two of your own",
  ...
  "Allure Focus": "allure focus allure when a majority of the domain cards in your loadout are from allure domain you may mark an armor slot instead of marking stress when you get a critical success on an action roll an enemy within close range takes 2 stress or an ally within close range gains 2 hope",
  ...
  "Recovery": "recovery allure during a rest you can always choose to do one of the long rest options instead you may spend a hope to let one additional party member do the same",
  ...
  "Assistent Drone": "assistent drone edge spend a hope to deploy a small droid it stays until your next rest until it takes damage or until you deactivate it with a reaction spend an extra hope to make it a floating droid you can talk to it or through it to others make a finesse or knowledge roll to command simple tasks or mark a stress to see through its eyes shield while very close to you it reduces an incoming damage by your armor score plus your proficiency it then deactivates unless you spend a hope drone attack spend an action to send it against a target within close of it make a finesse or knowledge attack roll on a success deal 2d8 energy damage",
  ...
  "Nano Medfield": "nano medfield edge once per rest you can use an action to trigger a field of tiny healing robots around you everywhere within close range of you is covered by this small cloud of tiny floating drones causing you and your allies in the area to immediately heal one hit point you can spend a hope to increase the healing power by an additional hit point",
  "Signature Move": "signature move edge when you take this card you take on a signature move in battle that you can perform once per rest name it and describe it when you include its description in an action you re taking use a d20 instead of a d12 as your hope die if the attack succeeds you may clear a stress",
  ...
  "Shocking Skin": "shocking skin edge once per rest spend a hope while touching a willing being and place a number of tokens equal to your knowledge trait on this card whenever the target takes damage you can remove any number of these tokens to roll that number of d6 and add half your level rounded down to the roll reduce the incoming damage by the result and if the attacker is in melee deal the same result of energy damage back to the attacker when you take a rest clear all tokens",
  "Bustling Load": "bustling load edge once per rest spend a hope to push your body and senses to their maximum capabilities describe how your appearance and body language change then place a d6 on this card at value of 6 while this die is active it adds its value to every action roll you make after you add its value to a roll reduce it by 1 when the die s value reaches 0 or you take a rest this state drops and you must mark an stress",
  "Edge Focus": "edge focus edge when a majority of the domain cards in your loadout are from edge domain increase your agility by 1 once per rest you can do a finesse or agility roll using the double of the trait score",
  ...
  "Awareness Projection": "awareness projection essence make a forcewield roll 12 on a success once per rest you project your perception and vigilance to a place you know within far range with radius no bigger than close range while you are concentrating you know everything that is happening in the chosen area if you are doing anything else you must make a forcewield roll 14 to perceive any activity the gm can give you advantage if the activity you are performing while projecting your awareness is simple enough",
  ...
  "Reliable Armor": "reliable armor havoc increase your armor score by 2 while you are wearing armor and this card is in your loadout once per rest you may use an armor slot without marking it",
  ...
  "Havoc Focus": "havoc focus havoc when a majority of the domain cards in your loadout are from havoc domain attack rolls always take 2 to their result increase your severe damage threshold by 4",
  ...
  "Ray Wall": "ray wall veil once per rest you can make a finesse roll 15 on a sucess spend a hope to place a ray shield wall from one point within close range of you to another the wall can be as high as 30ft 9m any creature or objects in its path are shunted to one side it will dissipate at the end of your next rest when you use this ability again or when gm spend 2 fear to end it",
  ...
  "Veil Focus": "veil focus veil when a majority of the domain cards in your loadout are from veil domain whenever you succeed with fear you gain a hope if your fear die ever rolls a 1 or 2 you may reroll it once and take the new result instead",
