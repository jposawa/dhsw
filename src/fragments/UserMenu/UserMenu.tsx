		...
		return (
			<div className={styles.wrapper} data-collapsed={isNavCollapsed}>
				<span className={[styles.trigger, styles.placeholder].join(" ")}>
					<i
						className={[styles.triggerSlot, styles.triggerIcon].join(" ")}
						aria-hidden="true"
					>
						<Icon name="account" />
					</i>
	...
	return (
		...
		>
			<button
				...
				aria-haspopup="menu"
				aria-label={
					signedUser ? `Perfil de ${signedUser.displayName}` : "Entrar"
				}
					...
					{signedUser ? (
						<>
							<header className={styles.identity}>
								<Avatar imageUrl={avatarUrl} name={shownName} size="md" />
						...
						<p className={styles.guestNote}>
							Sem conta, o compêndio fica aberto. Fichas pedem login.
						</p>
					)}
